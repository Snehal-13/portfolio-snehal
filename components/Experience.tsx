        ...
        <div className="w-full px-10 py-9">
          <main className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      ...
                      >
                        <div className="flex lg:flex-row flex-col lg:items-center p-3 py-6 md:p-5 lg:p-10 gap-2">
                          <img
                            src={card.thumbnail}
                            alt={card.thumbnail}
                            className="lg:w-25 md:w-20 w-16"
                          />
            ...
            <section className="col">
              ...
              <div className="relative pr-8 border-r-2 border-purple">
                <div className="w-full grid lg:grid-cols-2 grid-cols-1 gap-10 ">
                  {workExperience.map((card) => (
                    ...
                    >
                      <div className="flex lg:flex-row flex-col lg:items-center p-3 py-6 md:p-5 lg:p-10 gap-2">
                        ...
                        />
                        <div className="lg:ms-5">
                          <h1 className="text-start text-xl md:text-2xl font-bold mb-2">
                            {card.title}
                          </h1>
                          <p className="text-start text-purple font-semibold">
                            {card.companyTitle}
                          </p>
                          <p className="text-start text-white-100 mt-3 font-normal">
                            {card.desc}
